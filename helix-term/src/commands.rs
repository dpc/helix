...
impl MappableCommand {
    ...
    static_commands!(
        ...
        paste_after, "Paste at selection heads (same as paste_before)",
        paste_before, "Paste at selection heads (same as paste_after)",
        paste_clipboard_after, "Paste clipboard at selection heads (same as paste_clipboard_before)",
        paste_clipboard_before, "Paste clipboard at selection heads (same as paste_clipboard_after)",
